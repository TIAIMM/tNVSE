...
public:
	...
	static void SetRenderTargetGroup(NiRenderTargetGroup* apTarget, UInt32 uiClearMode) {
		CdeclCall(0x54EDE0, apTarget, uiClearMode);
	}

	static void SetOffScreenRenderTargetGroup(UInt32 auiClearMode, NiRenderTargetGroup* apTarget) {
		CdeclCall(0xB6B8D0, auiClearMode, apTarget);
	}
