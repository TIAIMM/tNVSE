...
public:
	...
	ImageSpaceTexture* GetTexture(UInt32 aiIndex) const;
	void SetTexture(UInt32 aiIndex, ImageSpaceTexture* apTex, TextureFilterMode aiFilterMode);

	void RenderShaderEx(NiGeometry* apScreenShape, NiDX9Renderer* apRenderer, ImageSpaceEffectParam* apParam, bool abEndFrame);
};
