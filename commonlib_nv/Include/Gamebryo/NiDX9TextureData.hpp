...
public:
	...
	static inline const NiRTTI ms_RTTI = NiRTTI("NiDX9TextureData", NiTexture::RendererData::ms_RTTI); inline const NiRTTI* GetRTTIEx() {return &NiDX9TextureData::ms_RTTI;};
