...
public:
	...
	virtual void	GetTriangleIndices(UInt16 i, UInt16& i0, UInt16& i1, UInt16& i2);
	virtual void	GetStripData(UInt16& usStrips, const UInt16*& pusStripLengths, const UInt16*& pusTriList, UInt16& uiStripLengthSum);
