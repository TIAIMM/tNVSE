...
public:
	ImageSpaceTexture() : spTexture(0), iFilterMode(TEXTURE_FILTER_MODE_NEAREST), iClampMode(TEXTURE_ADDRESS_MODE_DEFAULT), byte0(false), bIsRenderedTexture(false), bAcquiredTarget(false) { };
	...
	void				BorrowRenderedTexture(RenderTargetTypes aeType);
