...
public:
	...
	bhkWorldObject* GetWorldObject() const;
    void SetWorldObject(bhkWorldObject* apObject);

    static void EnableCollision(NiAVObject* apObject, bool abEnable);

    static void ResetSim(NiNode *thisPtr, const boolean bRecursive) {
        CdeclCall(0xC6BD00, thisPtr, bRecursive);
    }
};
