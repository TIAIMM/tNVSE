...
public:
	...
	virtual void RenderSortedPasses(BSShaderManager::RenderPassType aeMinPass, BSShaderManager::RenderPassType aeMaxPass, bool abBlendAlpha);
	...
	struct PassGroup {
		...
		void RemoveHead(UInt32 auiList);
	...
	double GetNextAlphaDepth(UInt32 auiGroup, const NiCamera* apCamera, bool abSortByClosestPoint) const;
	...
	void RegisterPassGeometryGroupEx(BSShaderProperty::RenderPass* apRenderPass, BSShaderManager::RenderPassType auiPassEnum);
	void RenderSortedPassesEx(BSShaderManager::RenderPassType aeMinPass, BSShaderManager::RenderPassType aeMaxPass, bool abBlendAlpha);
	...
	void IsFirstPass(UInt32 auiGroup, TransparencyType aeTransparency, bool& arbIsFirst) const;

	void ClearRenderPasses(bool abWarnNotEmpty = false);
	void StartGroupingAlphas(NiBound* apBound, bool abZPrePass, NiCamera* apCamera, bool abSortByClosestPoint);

	bool Unk_B99900(BSShaderManager::RenderPassType& arePass, TransparencyType& areTransparencyType);
	bool Unk_B9A090(BSShaderManager::RenderPassType& arePass, TransparencyType& areTransparencyType, bool& arbIsFirst);
	bool SetTransparencyType(UInt32 auiGroup, TransparencyType& areTransparencyType) const;
	bool Unk_B9A3C0(BSShaderManager::RenderPassType& arePass, BSBatchRenderer::TransparencyType& areTransparencyType, bool& arbIsFirst, bool abBlendAlpha = false);
	bool Unk_B9A120(BSShaderManager::RenderPassType& arePass, BSBatchRenderer::TransparencyType& areTransparencyType, bool& arbIsFirst, bool abBlendAlpha);

	bool SetAlphaMode(UInt32 aeTransparencyType, bool abMarkStatus);
