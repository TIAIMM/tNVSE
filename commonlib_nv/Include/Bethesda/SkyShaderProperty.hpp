...
public:
	...
	NiTexturePtr					spBaseTexture;
	BSString						strTextureName;
	NiTexturingProperty::ClampMode	eClampMode;
	NiTexturePtr					spBlendTexture;
	float							fBlendValue;
	UInt16							usCloudLayer;
	...
	void SetTexturePath(const char* apcName);
	void SetTexturePath(const NiFixedString& arName);
	void SetBaseTexture(NiTexture* apTexture);
};
