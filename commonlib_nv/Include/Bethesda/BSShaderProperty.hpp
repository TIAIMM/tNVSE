...
public:
	...
	public:
		...
		RenderPass(NiGeometry* apGeometry, BSShaderManager::RenderPassType aePassEnum, bool abFirst, UInt8 aucNumLights, ...);
		~RenderPass();
		...
		bool Between(UInt32 auiStart, UInt32 auiEnd) const;
		bool IsPass(UInt32 auiPassEnum) const;
		...
		void EmptyLightList();
		void AddLight(ShadowSceneLight* apLight);
	};
	...
	public:
		...
		void AddPass(NiGeometry* apGeometry, BSShaderManager::RenderPassType auiPassEnum, bool abFirst,
	...
	virtual BSShaderProperty*			PickShader(NiGeometry* apGeometry, UInt32 unk0 = 0, UInt32 unk2 = 1);
	...
	static void SetFlagRecurse(NiAVObject* object, const Flags aeFlags, const bool abEnable) {
		CdeclCall(0xBA91A0, object, aeFlags, abEnable);
	}
	...
	void GetViewerStringsEx(NiViewerStringsArray* apStrings);
...
#define ADD_PASS_ARGS NiGeometry* apGeometry, UInt16* apusPassCount, bool abAddPass, bool& abFirstPass
