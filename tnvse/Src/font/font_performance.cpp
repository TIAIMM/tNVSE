...
namespace fonthook::vectorfont
{
	...
	void ReportFreeTypePerf(bool force)
	{
		...
		FreeTypeFontDebugLog(
			...
			values[static_cast<size_t>(
				FreeTypePerfCounter::TextArtifactCompile)],
			values[static_cast<size_t>(
			...
			values[static_cast<size_t>(
				FreeTypePerfCounter::DirectCompositeConstructionWitness)],
			values[static_cast<size_t>(
				FreeTypePerfCounter::
			...
			values[static_cast<size_t>(
				FreeTypePerfCounter::
					TextArtifactShapeMetadataElementScanSaved)],
