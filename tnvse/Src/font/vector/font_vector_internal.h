...
namespace fonthook::vectorfont
{
	...
	enum class FreeTypePerfCounter : UInt16
	{
		...
		VisibilityClipPreConstants,
		VisibilityClipPostConstants,
		VisibilityLateClipCheck,
		...
		ThinRegistrationSourceFallback,
		ThinRegistrationSingletonTopology,
		ThinRegistrationSingletonFallback,
		ThinRegistrationGroupTopology,
		ThinRegistrationGroupFallback,
