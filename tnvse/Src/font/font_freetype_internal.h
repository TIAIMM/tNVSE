...
#pragma pack(pop)
	...
	// Version 11 replaces single-channel shader SDF records with D3D-native BGRA
	// MTSDF records generated by msdfgen v1.13. All older profiles are
	...
	constexpr UInt64 kMaximumPersistentSingleChannelProfileBytes =
		512ull * 1024ull * 1024ull;
	constexpr UInt64 kMaximumPersistentMtsdfProfileBytes =
		4ull * kMaximumPersistentSingleChannelProfileBytes;
