...
namespace
{
	void LogLoadedTnvseModuleIdentity(const void* address)
	{
		...
		gLog.FormattedMessage(
			"tnvse_build_identity: diagnostics=instancing-admission-live-split-compat-timing-v9 module=%s base=%p peTimestamp=0x%08X imageSize=%u fileBytes=%llu fileWriteTime=0x%016llX fnv1a64=0x%016llX moduleError=%u fileError=%u",
